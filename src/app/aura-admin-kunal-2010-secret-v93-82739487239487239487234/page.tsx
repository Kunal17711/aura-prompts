...
export default function AdminDashboard() {
  const stats = [
    { label: 'Total Prompts', value: '1,284', icon: <Database size={24} />, color: 'bg-aura-black', trend: '+12% this week' },
    { label: 'Active Subs', value: '412', icon: <TrendingUp size={24} />, color: 'bg-aura-black', trend: '+5.4% conversion' },
    { label: 'Total Users', value: '12.8k', icon: <Users size={24} />, color: 'bg-aura-black', trend: '+124 today' },
    { label: 'Revenue', value: '₹32.4k', icon: <Zap size={24} />, color: 'bg-aura-black', trend: 'Live data' },
  ]
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="p-10 bg-white rounded-[60px] border border-aura-light-gray space-y-8">
          ...
          <div className="space-y-4">
            ...
            <div className="pt-4">
              <p className="text-[10px] font-black text-aura-gray uppercase tracking-[0.2em] mb-4">Authorized ID</p>
              <div className="p-4 bg-aura-light-gray/50 rounded-2xl font-mono text-[10px] break-all">
                {process.env.NEXT_PUBLIC_ADMIN_USER_IDS || 'SECURE_NODE_01'}
              </div>
            </div>
          </div>
        </div>
