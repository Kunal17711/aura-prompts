...
export function HomeClient({ initialPrompts }: { initialPrompts: any[] }) {
  ...
  return (
    <main className="min-h-screen bg-aura-white text-aura-black overflow-x-hidden">
      ...
      {/* Footer */}
      <footer className="py-24 px-4 bg-white border-t border-aura-light-gray">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-start gap-12">
          <div className="space-y-6 max-w-sm">
            <h3 className="text-3xl font-bold tracking-tighter">AURA</h3>
            <p className="text-aura-gray text-lg">The world's most premium AI prompt gallery. Design your reality, one prompt at a time.</p>
          </div>
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-12 md:gap-24">
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-2 font-medium">
                ...
                <li><a href="https://instagram.com/iiblamekunal" className="hover:text-aura-gray transition-colors">Instagram</a></li>
              </ul>
            </div>
            <div className="space-y-4">
        ...
        <div className="max-w-7xl mx-auto mt-24 pt-12 border-t border-aura-light-gray flex flex-col sm:flex-row justify-between items-center gap-6 text-aura-gray font-medium">
